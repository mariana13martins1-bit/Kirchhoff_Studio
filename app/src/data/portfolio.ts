...
export const portfolioItems = [
  ...
  { id: 603, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351354/DSC_6734_hzeqyj.jpg', title: 'Shadow and Form', category: 'architecture', size: 'large' },
  ...
  { id: 606, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351349/DSC_1467_zcmg9c.jpg', title: 'Contemporary Space', category: 'architecture', size: 'large' },
  ...
  { id: 108, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351188/BDD200B9-74D5-40C1-AB30-34A48ACB0CC8_1_105_c_yhkhtd.jpg', title: 'Endurance', category: 'sports', size: 'small' },
  { id: 109, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351183/153855E3-EEE0-47C6-A410-513C149F723F_1_105_c_rkpwab.jpg', title: 'Street Sports', category: 'sports', size: 'medium' },
  ...
  // COUPLES
  { id: 300, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351323/Facetune_25-10-2025-17-49-07_hpaft2.jpg', title: 'Golden Hour Embrace', category: 'couples', size: 'large' },
  ...
  // NATURE
  { id: 500, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351261/DSC_5852_ouogrl.jpg', title: 'Mountain Silence', category: 'nature', size: 'large' },
  { id: 501, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351260/DSC_5801_gs3zrh.jpg', title: 'Alpine Vista', category: 'nature', size: 'small' },
  { id: 502, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351258/DSC_5698_frfbad.jpg', title: 'Forest Path', category: 'nature', size: 'medium' },
  { id: 503, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351258/DSC_5731_h59eo4.jpg', title: 'Wild Highlands', category: 'nature', size: 'large' },
  ...
  { id: 505, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351253/DSC_5691_p0yesa.jpg', title: 'Golden Wilderness', category: 'nature', size: 'small' },
  { id: 506, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351251/DSC_5579_t80arw.jpg', title: 'Quiet Horizon', category: 'nature', size: 'medium' },
  { id: 507, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351249/DSC_5509_dmmt1e.jpg', title: 'Rugged Beauty', category: 'nature', size: 'large' },
  { id: 508, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351248/DSC_5492_oevv6i.jpg', title: 'Nature Unfiltered', category: 'nature', size: 'small' },
  { id: 509, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351247/DSC_5440_mxbpzi.jpg', title: 'Earth Tones', category: 'nature', size: 'medium' },
  { id: 510, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351245/DSC_5392_jsx4i9.jpg', title: 'Serene Escape', category: 'nature', size: 'large' },
  
  // BRANDS
  { id: 400, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351222/8F172B53-2279-46A9-8937-A7023E95A89F_pjqijd.jpg', title: 'Brand Identity', category: 'brands', size: 'large' },
  { id: 401, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351200/F41E50C7-A8CC-448F-9422-3627435666FE_ykghry.jpg', title: 'Product Focus', category: 'brands', size: 'small' },
  { id: 402, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351186/B2043612-A40C-4DCC-832F-7AF2127E69D6_1_105_c_wbptsj.jpg', title: 'Minimalist Detail', category: 'brands', size: 'medium' },
  { id: 403, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351185/B2187C64-93E6-47F1-B089-B0DE99E691D8_1_105_c_lxqhpl.jpg', title: 'Texture & Tone', category: 'brands', size: 'large' },
  { id: 404, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351182/0248A6A9-C1B6-4AC5-A907-4CE67705059F_ghtsel.jpg', title: 'Lifestyle Shot', category: 'brands', size: 'medium' },
  { id: 405, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351179/82F6AA66-643B-49E6-8EB7-3D005B132C63_jdi4hq.jpg', title: 'Studio Clean', category: 'brands', size: 'small' },
  { id: 406, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351175/40AA9C64-FB5D-4396-AA93-BA9377CBCD37_1_105_c_fdqshc.jpg', title: 'Detail Oriented', category: 'brands', size: 'medium' },
  ...
  { id: 408, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351163/3A5E290A-8B9D-4C04-BE24-E011680BB326_1_105_c_nzlocm.jpg', title: 'Modern Aesthetics', category: 'brands', size: 'small' },
  { id: 409, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351161/1FDEF871-23E4-4D2F-AABD-A983334CDD15_1_105_c_s06e0t.jpg', title: 'Sleek Composition', category: 'brands', size: 'medium' },
  { id: 410, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351159/1E0A90C7-FC25-444D-A88A-23958CCC98CE_1_105_c_ppjaww.jpg', title: 'Crafted Narrative', category: 'brands', size: 'large' },
  { id: 411, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351158/0FE44B76-7266-4EC6-8A97-A094ED34D1F7_pb7ilb.jpg', title: 'Elegant Branding', category: 'brands', size: 'medium' },
  ...
  { id: 413, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351135/DSC_1695_z3ugkr.jpg', title: 'Signature Style', category: 'brands', size: 'medium' },
  { id: 414, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351056/DSC_6035_q9ealy.jpg', title: 'Professional Edge', category: 'brands', size: 'large' },
  { id: 415, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351055/DSC_6021_gffvbr.jpg', title: 'Light & Shadow', category: 'brands', size: 'small' },
  { id: 416, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351053/DSC_2743_lpidcw.jpg', title: 'Visual Impact', category: 'brands', size: 'medium' },
  { id: 417, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351052/DSC_2734_ba3nwm.jpg', title: 'Dynamic Brand', category: 'brands', size: 'large' },
  { id: 418, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351051/DSC_1710_g283uc.jpg', title: 'Authentic Tone', category: 'brands', size: 'small' },
  { id: 419, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351050/DSC_1582_x96k4f.jpg', title: 'Conceptual Design', category: 'brands', size: 'medium' },
  ...
  { id: 421, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351047/5DA91B15-1A66-4A5B-B9D1-909C77F30544_1_105_c_gsjxw2.jpg', title: 'Action Brand', category: 'brands', size: 'small' },
  ...
  { id: 423, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351288/DSC_1143_eunbqu.jpg', title: 'Corporate Event', category: 'brands', size: 'small' },
  { id: 424, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351286/DSC_1113_s5lqdv.jpg', title: 'Event Atmosphere', category: 'brands', size: 'medium' },
  { id: 425, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351284/DSC_1112_ko2xs9.jpg', title: 'Professional Gathering', category: 'brands', size: 'large' },
  { id: 426, image: 'https://res.cloudinary.com/djaacn6yd/image/upload/v1771351283/DSC_1077_ajk577.jpg', title: 'Brand Interaction', category: 'brands', size: 'small' },
